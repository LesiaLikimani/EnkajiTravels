...
$(window).on('scroll', function () {
    if ($(window).scrollTop() > 70) { // Set position from top to add class
        ...
        $('.navbar .navbar-brand.orange_logo> img').attr('src', 'img/leftlogo.png');
        ...
        $('.index-light .navbar .navbar-brand.orange_logo> img').attr('src', 'img/leftlogo.png');
        ...
        $('.active-navbar .navbar .navbar-brand.orange_logo> img').attr('src', 'img/leftlogo.png');
